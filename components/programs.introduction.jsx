        ...
        <Tabs >
            ...
            >
                {data.map((tab, index) => (
                    ...
                    ><Text fontSize={{ base: 'sm', md: 'lg' }} noOfLines={1} color={''}>{tab.label}
                        </Text></Tab>
                ))}
            </TabList>
            <TabPanels>
                {data.map((tab, index) => (
                    <TabPanel p={4} key={index}>
                        <Flex gap={10} direction={{ base: 'column', lg: 'row' }} padding={10} mt={-4} bg='#f5f7f9' boxShadow={"var(--chakra-shadows-xl)"} borderRadius='7'>

                            <Box>
                                <Heading color='#214B24' size='2xl' mt={5}>{programs[index].title}</Heading>
                                <Heading size='md' color='#37B34A' pt={5} pb={5}>{programs[index].subtitle}</Heading>
                                <Text textAlign={'justify'} lineHeight='2.0'>{programs[index].description}</Text>
                            </Box>
                            <Box mt={10}>
                                <Image

                                    flex={1} src={programs[index].image_1} alt={programs[index].title}
                                ...
                                <Box mt={'20'} textAlign={'center'}>
                                    ...
                                    <Text lineHeight={'1.7rem'}>Are you interested in partnering with<br />
